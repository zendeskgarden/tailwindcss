...
import { Message, Action } from "./components/Message";
    ...
    <div className="py-4 px-2">
      ...
      <div className="max-w-4xl mx-auto mt-16">
        <h1 className="text-3xl leading-3xl font-semibold mb-6">
          Zendesk Garden TailwindCSS Example
        </h1>
        <p className="mb-5">
          This is a mock implementation using{" "}
          <a href="https://tailwindcss.com/">TailwindCSS</a> and the{" "}
          <a href="https://github.com/zendeskgarden/tailwindcss">
            @zendeskgarden/tailwindcss
          </a>{" "}
          plugin. No custom styles are used in this example, with all styling
          and states being provided by Garden design tokens.{" "}
          <a href="https://github.com/zendeskgarden/tailwindcss/tree/main/example">
            View the source
          </a>{" "}
